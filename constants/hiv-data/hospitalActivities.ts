...
export const HOSPITAL_ACTIVITIES: ActivityCategoryType = {
  "Human Resources (HR)": [
    ...
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "Chief Medical Dr. Salary"
    },
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "Junior Medical Dr. | Mentor Salary"
    },
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "Pharmacist Salary"
    },
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "Nurse Salary"
    },
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "CHW supervisor Salary"
    },
    {
      activity: "Provide salaries for health facilities staff (DHs, HCs)",
      typeOfActivity: "Accountant Salary"
    },
    {
      activity: "Provide bonus for 2023-24",
      typeOfActivity: "All Staff Bonus"
    },
  ],
  ...
  "Program Administration Costs (PA)": [
    {
      ...
      typeOfActivity: "Bank charges & commissions"
    },
    {
      activity: "National and sub-HIV databases",
      typeOfActivity: "Fuel"
    },
    {
      ...
      typeOfActivity: "Communication (Airtime)"
    },
    {
      activity: "Infrastructure and Equipment",
      typeOfActivity: "Communication (Internet)"
    }
  ],
}; 